...
APP_ID = int(os.environ.get("APP_ID", "2471816"))
...
#shortlink
SHORTENER_API = os.environ.get("SHORTENER_API", "52485ddd93ca298fd075e8979a5889721ca48f75")
SHORTENER_SITE = os.environ.get("SHORTENER_SITE", "tnlink.in")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1337528464 1389078939 1245135578").split()):
        ADMINS.append(int(x))
except ValueError:
